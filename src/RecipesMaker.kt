...
fun makeRecipes(recetaIn: MutableMap<String, java.util.ArrayList<String>> ){
    //1. Hacer una receta
    ...
    recetaIn[nombreReceta] = filteredIngredientes
}

fun viewRecipes(recetaIn: MutableMap<String, java.util.ArrayList<String>>){
    val menu2 = """
